...
ADD resources/geoserver-${GEOSERVER_VERSION}-war.zip ${GEOSERVER_INSTALL_DIR}/geoserver-${GEOSERVER_VERSION}-war.zip
...
# Extenstions
ADD geoserver-exts/ /var/local/geoserver-exts/
